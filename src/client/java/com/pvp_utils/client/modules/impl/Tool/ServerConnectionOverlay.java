...
public final class ServerConnectionOverlay {
    ...
    public static void render(GuiGraphicsExtractor graphics, int width, int height, Component status) {
    ...
    public static void renderFailure(GuiGraphicsExtractor graphics, int width, int height) {
        Minecraft client = Minecraft.getInstance();
        if (client == null) return;
