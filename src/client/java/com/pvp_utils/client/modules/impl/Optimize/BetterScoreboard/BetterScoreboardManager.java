...
public final class BetterScoreboardManager {
    ...
    public static Rect getCurrentRect(int guiW, int guiH) {
        ...
        if (client.level != null) {
            ...
            if (objective != null && client.gui != null) {
                lastRect = measure(client.gui.font, guiW > 0 ? guiW : client.getWindow().getGuiScaledWidth(), guiH > 0 ? guiH : client.getWindow().getGuiScaledHeight(), objective);
                return lastRect;
            }
        }
    ...
    private static Rect measure(GuiGraphicsExtractor graphics, Objective objective) {
        return measure(Minecraft.getInstance().gui.font, graphics.guiWidth(), graphics.guiHeight(), objective);
    }
    ...
    private static boolean hasCustomFont(Style style) {
        return style != null && style.font != null && !style.font.equals(Style.EMPTY.font);
    }
