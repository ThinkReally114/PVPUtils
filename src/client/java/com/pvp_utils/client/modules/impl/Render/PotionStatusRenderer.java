...
public class PotionStatusRenderer {
    ...
    public void render(GuiGraphicsExtractor graphics) {
        ...
        if (client.player == null || client.level == null || client.getGui().hud.isHidden() || client.gui.screen() instanceof SkiaScreen || client.gui.screen() instanceof NeteaseMusicScreen) {
            clearPendingFrame();
            return;
        }
    ...
    public void renderFrameEnd() {
        ...
        Minecraft client = Minecraft.getInstance();
        if (!Config.potionStatus || client.getGui().hud.isHidden() || client.gui.screen() instanceof SkiaScreen || client.gui.screen() instanceof NeteaseMusicScreen) {
            clearPendingFrame();
            return;
        }
    ...
    public boolean shouldHideVanillaEffects() {
        ...
        Minecraft client = Minecraft.getInstance();
        if (client.player == null || client.level == null || client.getGui().hud.isHidden() || client.gui.screen() instanceof SkiaScreen || client.gui.screen() instanceof NeteaseMusicScreen) return false;
