...
public class PotionStatusRenderer {
    ...
    public void render(GuiGraphicsExtractor graphics) {
        ...
        if (client.player == null || client.level == null || client.options.gui.hud.isHidden() || client.gui.gui.screen()() instanceof SkiaScreen || client.gui.gui.screen()() instanceof NeteaseMusicScreen) {
            clearPendingFrame();
            return;
        }
    ...
    public void renderFrameEnd() {
        ...
        Minecraft client = Minecraft.getInstance();
        if (!Config.potionStatus || client.options.gui.hud.isHidden() || client.gui.gui.screen()() instanceof SkiaScreen || client.gui.gui.screen()() instanceof NeteaseMusicScreen) {
            clearPendingFrame();
            return;
        }
    ...
    public boolean shouldHideVanillaEffects() {
        ...
        Minecraft client = Minecraft.getInstance();
        if (client.player == null || client.level == null || client.options.gui.hud.isHidden() || client.gui.gui.screen()() instanceof SkiaScreen || client.gui.gui.screen()() instanceof NeteaseMusicScreen) return false;
