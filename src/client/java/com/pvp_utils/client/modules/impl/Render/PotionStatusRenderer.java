...
public class PotionStatusRenderer {
    ...
    public void render(GuiGraphicsExtractor graphics) {
        ...
        if (client.player == null || client.level == null || client.options.gui.hud.isHidden() || client.screen instanceof SkiaScreen || client.screen instanceof NeteaseMusicScreen) {
            clearPendingFrame();
            return;
        }
    ...
    public void renderFrameEnd() {
        ...
        Minecraft client = Minecraft.getInstance();
        if (!Config.potionStatus || client.options.gui.hud.isHidden() || client.screen instanceof SkiaScreen || client.screen instanceof NeteaseMusicScreen) {
            clearPendingFrame();
            return;
        }
    ...
    public boolean shouldHideVanillaEffects() {
        ...
        Minecraft client = Minecraft.getInstance();
        if (client.player == null || client.level == null || client.options.gui.hud.isHidden() || client.screen instanceof SkiaScreen || client.screen instanceof NeteaseMusicScreen) return false;
